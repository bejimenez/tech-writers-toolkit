...
"""Database models for document storage and metadata management"""
...
@dataclass
class ReviewSession:
    """A complete review session for a document"""
...
class DatabaseManager:
    """Manages SQLite database operations for review sessions and findings"""
